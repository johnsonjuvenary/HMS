<div class="card">
  <div class="card-body">
    <h5 class="text-dark text-center">Male Students Selected</h5>
    <hr />
    <?php
    //selecting only selected students
    $select_selected_students = mysqli_query($connection, "SELECT * FROM applicants,students WHERE gender = 'male' AND students.regno = applicants.student_regno AND selected = 'selected' ORDER BY 'first_name'");
