<div class="card">
  <div class="card-body">
    <h5 class="text-dark text-center">Male Students Applications</h5>
    <hr />
    <?php
    //checking for applications
    $check_applications = mysqli_query($connection, "SELECT * FROM applicants,students WHERE applicants.student_regno = students.regno AND gender = 'male' ORDER BY when_applied");
