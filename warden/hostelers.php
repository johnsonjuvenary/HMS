...
<div class="container-fluid" style="margin-top: 56px;">
  <div class="row">
    ...
    <!-- contents -->
    <?php
    //checking rooms and blocks
    $rooms = mysqli_query($connection, "SELECT room_number,number_of_beds,block_name FROM rooms,blocks WHERE rooms.block_id = blocks.id");
    ?>
    <div class="col-md-9 col-lg-10 py-5 bg-light contents">
      <div class="card">
        <h5 class="card-header">Hostelers</h5>
        <div class="card-body">
              ...
              <div class="col-10">
                <div class="tab-content" id="nav-tabContent">
                  <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                    <?php include 'hostelers/female.php'; ?>
                  </div>
                  <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
                    <?php include 'hostelers/male.php'; ?>
                  </div>
                </div>
              </div>
            </div>
