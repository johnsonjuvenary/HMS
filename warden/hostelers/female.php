<div class="card">
  <div class="card-body">
    <h5 class="text-dark text-center">Female Students Hostelers</h5>
    <hr />
    <?php
    //selecting only Hostelers
    $select_selected_students = mysqli_query($connection, "SELECT * FROM hostelers,students,applicants WHERE students.regno = hostelers.student_regno AND students.regno = applicants.student_regno AND selected = 'selected' AND payment = 'paid' AND students.gender = 'female'  ORDER BY first_name");
